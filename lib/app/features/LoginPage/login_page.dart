    ...
    return Scaffold(
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          image: DecorationImage(image: AssetImage('images/bckb.jpg'), fit: BoxFit.cover),
        ),
        child: ListView(
          shrinkWrap: true,
          ...
          children: [
            Center(
              child: Text(style: const TextStyle(fontSize: 30), isCreatingAccount == true ? 'Sing up' : "Login"),
            ),
            const Padding(
